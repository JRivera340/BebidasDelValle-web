...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-3">
              ...
              <h3 className="text-xl font-semibold">Presentación premium</h3>
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="text-xl font-semibold">Selección de temporada</h3>
              <p className="text-gray-600">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-brand-gold to-brand-gold-hover text-white">
        <div className="container mx-auto px-4 text-center space-y-6">
          <h2 className="text-4xl font-bold">¿Listo para crear tu cesta personalizada?</h2>
          ...
          <Button
            asChild
            size="lg"
            className="bg-white text-brand-gold hover:bg-gray-100 group"
          >
            <a
              href={waBasketMessage()}
              target="_blank"
